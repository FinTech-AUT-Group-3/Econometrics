...
The p-value of the coefficient of age is < 2.2e-16, which is close to zero. At a significance level of 0.01%, we can reject the null hypothesis. Thus, based on our probit regression, we can conclude that age is a statistically significant determinant of employment in April 2009.
